...
void Process_System_Alarm_States()
{
	...
	// 		if (data_global.batt_error_current == false && data_global.engineStalled_current == false && data_global.temp_alarmFlag_current == false && data_global.temp_errorFlag_current == false && System_Test_Alarm_Active == false && CurrentAuxInVal == AuxIn::Inactive)
	// 		{
	// 			// Check Battery
	// 			if (data_global.batt_error_previous == true) { data_global.battchanged = true; }
	// 			//Check Stall
	...
	// 			if (data_global.temp_alarmFlag_previous == true) { data_global.temp_changed = true; }
	// 			// Check Temperature Sensor Flag
	// 			if (Previous_Temp_Sensor_Error_Flag == true) { data_global.temp_changed = true; }
	// 			// Daisy Chain Flag
	// 			if (PreviousAuxInVal == true) { data_global.aux_changed = true; }
	...
	// 		if (data_global.batt_error_current == true || data_global.engineStalled_current == true || data_global.temp_alarmFlag_current == true || data_global.temp_errorFlag_current == true || CurrentAuxInVal == true)
	// 		{
	// 			// Check Battery
	// 			if (data_global.batt_error_previous == true) { data_global.battchanged = true; }
	// 			// Check Stall
